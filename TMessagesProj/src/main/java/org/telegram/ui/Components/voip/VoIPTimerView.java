...
public class VoIPTimerView extends View {
    ...
    private Drawable endCallDrawable;
    private boolean showEndCall;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (showEndCall) {
            if (endCallDrawable == null) {
                endCallDrawable = getResources().getDrawable(R.drawable.calls_decline);
                endCallDrawable.setBounds(0, 0, AndroidUtilities.dp(15), AndroidUtilities.dp(15));
            }
            endCallDrawable.draw(canvas);
        } else {
            canvas.save();
    ...
    public void setShowEndCall(boolean show) {
        this.showEndCall = show;
        invalidate();
    }
}
