...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean onFragmentCreate() {
        ...
        webSessionsActivityPreload.setDelegate(() -> {
            if (listAdapter != null) {
                int webSessionsCount = webSessionsActivityPreload.getWebSessionsCount();
    ...
    private void updateRows(boolean notify) {
        ...
        if (webSessionsActivityPreload != null && webSessionsActivityPreload.getWebSessionsCount() > 0) {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 5:
                    ...
                    if (position == autoDeleteMesages) {
                        ...
                        String count = "";
                        if (devicesActivityPreload.getDeviceSessionsCount() == 0) {
                            ...
                            count = String.format(LocaleController.getInstance().getCurrentLocale(), "%d", devicesActivityPreload.getDeviceSessionsCount());
                        }
                        getMessagesController().lastKnownSessionsCount = devicesActivityPreload.getDeviceSessionsCount();
